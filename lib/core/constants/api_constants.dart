class ApiConstants {
  ...
  static const String emergencyIncidentStats =
      '/emergency-incidents/statistics';
  static const String emergencyCitizenMapping =
      '/emergency-incidents/citizen-mapping-data';
  static String emergencyIncidentDetail(int id) => '/emergency-incidents/$id';
  static String emergencyLocationUpdates(int id) =>
      '/emergency-incidents/$id/location-updates';
  static String emergencyUpdateStatus(int id) =>
      '/emergency-incidents/$id/update-status';
  ...
  static String staffChatMessages(int id) =>
      '/staff/incidents/$id/chat/messages';
  ...
  static String injuryReport(int incidentId) =>
      '/incidents/$incidentId/injury-report';

  // E-Street Form Endpoints
  static String eStreetForm(int incidentId) =>
      '/incidents/$incidentId/e-street-form';

  // Pre-Dispatch Checklist Endpoints
  static const String preDispatchChecklistsEndpoint =
      '/pre-dispatch-checklists';
  static const String teamMembersEndpoint = '/team-members';
